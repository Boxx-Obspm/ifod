...
function[dr,Dvectr,Dvelocity]=test_interpolation(ii,timeStep,trajectory_name,trajectory_name_ephjup)
...
distance0=[distance0_1;distance0_2;distance0_3;distance0_4]; % distance0 is the interpolation at 4 different time of the reference trajectory of the distance between BIRDY and JUPITER. 
coordinates0=[x0_1 y0_1 z0_1;x0_2 y0_2 z0_2;x0_3 y0_3 z0_3;x0_4 y0_4 z0_4]; % coordinates0 is the interpolation at 4 different time of the reference trajectory of BIRDY's corrdinates.
...
Dvectr=coordinates0-coordinates1; 
Dvelocity=(velocity1-velocity0)/1000;
dr=distance1-distance0;
